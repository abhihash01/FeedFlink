...
from env.env import API_KEYS,NEWSTOPIC1,NULL_REPLACEMENTS,LANGS,TOPIC_QUERY,PAGE,PAGE_SIZE,REDIS_HOST,KAFKA_BOOTSTRAP_SERVERS


class NewsProducer:
    def __init__(self):

        self.topic=NEWSTOPIC1
        self.page=PAGE
        self.page_size=PAGE_SIZE
        self.null_replacements=NULL_REPLACEMENTS
        self.LANGS=LANGS
        self.query=TOPIC_QUERY
        self.page=self.page       
        ...
        self.newsapi = NewsApiClient(api_key=API_KEYS[0])
    ...
    def send_to_kafka(self, articles, news_id_prefix):
        ...
        for _, article in articles.iterrows():
            ...
            print(f'sendgin to Kaka topic {self.topic} to write')
